...
_current_grounding: GroundingContext | None = None


async def build_session_grounding(
    active_mode: str = DEFAULT_MODE, selected_model: str = DEFAULT_MODEL
) -> GroundingContext:
...
def get_session_grounding() -> GroundingContext | None:
